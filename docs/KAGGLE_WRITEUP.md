...
**Title:** Sickle Cell Body Quest: Empowering SCD Patients with Dr. Hemo
...
Sickle Cell Body Quest is an interactive, gamified educational app that leverages the MedGemma model to provide compassionate, SCD-specific medical guidance through a friendly virtual assistant, Dr. Hemo.
...
We built **Sickle Cell Body Quest**, a platform that transforms medical education into an exploration of the human body. 
...
- **Demo Video:** [Sickle Cell Body Quest - Demo](https://youtu.be/Mkotijh8V6M)
